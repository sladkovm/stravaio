...
class GearsApi(object):
    ...
    def get_gear_by_id(self, id, **kwargs):  # noqa: E501
        ...
        :param str id: The identifier of the gear. (required)
        :return: DetailedGear
    ...
    def get_gear_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get Equipment  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_gear_by_id`")  # noqa: E501
